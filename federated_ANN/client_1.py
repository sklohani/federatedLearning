...
## Import train data
data = pd.read_csv("../data/data/node01/data.csv", index_col=0)
...
np.savetxt('./results/accuracy_client_1.txt', accuracy_list)
np.savetxt('./results/loss_client_1.txt', loss_list)